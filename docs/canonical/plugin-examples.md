...
**Public Data Plugin** — No authentication required.
...
3. Extract relevant fields: temperature, condition, humidity, forecast
4. Normalize data
...
**Authenticated Plugin** — Requires IntegrationConnection.
...
| Aspect | Weather Plugin | Google Calendar Plugin |
|--------|----------------|------------------------|
| Authentication | No | Yes (IntegrationConnection) |
| Data Source | Public API | Authenticated API |
| Config Complexity | Simple | More complex |
| Token Management | N/A | Via adapter |
