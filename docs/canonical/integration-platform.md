...
1. **Connection Layer** → stores and manages user accounts
2. **Adapter Layer** → communicates with external providers
3. **Resolver Integration** → used by plugins via runtime
...
With the canonical documentation:

1. **plugin-platform-architecture.md** — System design and three planes
2. **integration-platform.md** — Integration contracts and adapters
3. **plugin-sdk.md** — Plugin development contracts
4. **plugin-examples.md** — Reference implementations
