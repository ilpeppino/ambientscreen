...
const baseProps = {
  ...
  }] as import("@ambient/shared-contracts").Profile[],
  activeProfileId: "p1",
  profileError: null,
  newProfileName: "",
  ...
  slideDurationInput: "30",
  setSlideDurationInput: vi.fn(),
  slideDurationError: null,
  savingSlideDuration: false,
  onSaveSlideDuration: vi.fn(),
